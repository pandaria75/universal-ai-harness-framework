...
Use `subagent` with `agent: "marionettist-indexer"` for ownership, docs, rules, and call-path exploration.
Use `subagent` with `agent: "marionettist-planner"` to create small implementation slices and validation strategy after scope is clear.
